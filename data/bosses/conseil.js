...
// Zerevor (mage) au nord-ouest, Malande (pretresse) au nord-est, Veras (voleur) au
// sud, Gathios tire a l'ecart a droite : ses auras renforcent le conseil autour de lui.
pc(  36,   55, 'tank');   // tank Gathios (guerrier : Renvoi de sort)
pc(-279, -262, 'tank');   // tank Malande (guerrier : interruption)
pc(-470,  152, 'tank');   // tank Veras   (paladin ou druide)
pc(-790, -150, 'rdps');   // mage sur Zerevor, tenu HORS des 10 m
