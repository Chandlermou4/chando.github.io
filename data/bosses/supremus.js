window.GUIDE_STEPS=[{"mech": "Placement", "t": 8, "txt": "Trois tanks, tous <strong>au nord</strong> et tournés vers le sud. Le tank principal tient Supremus ; les <strong>deux autres restent en mêlée</strong>, maintenus au maximum de vie — ce sont eux qui encaissent la Frappe haineuse. Derrière le boss, tout le raid s'étale largement : il y a de la place, on l'utilise.", "focus": ["tank"]}, {"mech": "Frappe haineuse", "t": 8, "txt": "Supremus frappe régulièrement, et très fort, le joueur <strong>au corps-à-corps qui a le plus de vie</strong> sur le moment — hors tank principal, et sans aucun rapport avec la menace. D'où les deux tanks supplémentaires collés à lui. <strong>Aucun DPS mêlée ne doit avoir plus de vie que ces tanks.</strong>", "focus": ["tank", "healer"]}, {"mech": "Flamme de la fournaise", "t": 8, "txt": "Des <strong>lignes de flammes</strong> partent vers des joueurs au hasard et restent au sol une dizaine de secondes. On en sort tout de suite."}, {"mech": "Phase de kite", "t": 9, "txt": "Supremus <strong>arrête de taper</strong> et se fixe sur un joueur au hasard, <strong>change de cible toutes les dix secondes</strong>. Le joueur visé le tient à <strong>mi-distance</strong> : trop près, le Punch de la fournaise le repousse et le tue ; trop loin, Supremus charge."}, {"mech": "Geyser volcanique", "t": 8, "txt": "Pendant le kite, des <strong>geysers</strong> éclatent au sol — boules de feu à <strong>grosse range</strong>. Personne ne reste groupé, on bouge en continu, les soigneurs passent aux <strong>soins instantanés</strong> ; le joueur qui kite contourne les geysers de loin.", "focus": ["healer"]}, {"mech": "Retour en phase 1", "t": 7, "txt": "Le <strong>dernier joueur fixé ramène Supremus</strong> vers la zone de tank de la phase 1. La menace est <strong>remise à zéro</strong> : un Détournement de chasseur permet au tank principal de le reprendre aussitôt."}];
